...
EXPERIMENT_PATH = '/hdd2/style_transfer/jrcai_authorship/output/experiments/38 - AceGPT-v2-8B-Chat - bs1/'
...
llm_loaders = [
    ...
    # ),
    LLMLoader(
        '/hdd/shared_models/AceGPT-v2-8B-Chat/',
        llm_initializer=AceGPT2Initializer(
            max_length=3000,
        )
    ),
]
...
run_llm_jobs_in_parallel([
    ...
    for author in  ['all_authors'] + authors
])
